...
**Technologies:** Elasticsearch, Kibana, Python, AWS, Scikit-learn, Isolation Forest, SIEM Monitoring, Telemetry Simulation - i just want to bold just the technolgies
